...
$sql="INSERT INTO datos (IdServicios, NombreServicio, Direccion, RFC, Telefono, Latitud, Longitud, Foto,clasificacion_id) VALUES('','$nom','$dir','$rfc','$tel','$lat','$longt', '$foto','$clasif')";
